...
class Help extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <li>2. Job 1 updates from WorkDay</li>
      <li>3. Job 2 updates from GC</li>
      ...
      <ul>
      <li>1. All the information will be in one table and the strucutre will be as we see it</li>
      ...
      <li> or have small clickable icon to keep exapnd the budget details and still be editable</li>
